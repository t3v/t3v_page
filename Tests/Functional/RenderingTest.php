<?php
namespace T3v\T3vPage\Tests\Functional;
 ...
 *
 * @package T3v\T3vPage\Tests\Functional
 */
class RenderingTest extends FunctionalTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->setUpFrontendRootPage(1, ['EXT:t3v_page/Tests/Functional/Fixtures/Frontend/Basic.typoscript']);
    }
