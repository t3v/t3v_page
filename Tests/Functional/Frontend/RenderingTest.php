...
namespace T3v\T3vPage\Tests\Functional\Frontend;
 ...
 *
 * @package T3v\T3vPage\Tests\Functional\Frontend
 */
class RenderingTest extends FunctionalTestCase
{
    ...
    public function templateIsRendered(): void
    {
        ...
        if ($response->getStatusCode() === 200) {
            ...
            self::assertStringContainsString('Home | T3v Page', $titleTag->nodeValue);
