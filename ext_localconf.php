...
// Adds `tx_t3vpage_claim`, `tx_t3vpage_summary`, `tx_t3vpage_outline` and `tx_t3vpage_thumbnail` field to the root line:
...
// Adds `tx_t3vpage_claim`, `tx_t3vpage_summary` and `tx_t3vpage_outline` field to the page overlay fields:
